    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex flex-wrap md:flex-nowrap mb-24">
        <div className="md:w-1/2 p-8">
          <h1 className="text-3xl font-bold mb-4 mt-24">KingsWord Church, Vancouver</h1>
          <p>KingsWord International Church, Vancouver, is a one of the branches of KingsWord Ministries International.</p>
